...
function Button(x, y, label, onClick) {
    this.label = label;
    this.x = x;
    this.y = y;
    ...
    if (typeof(onClick) === 'function') {
        this._sprite.onMousePressed = function () {
            if (this.visible && isNextClick) {
                isNextClick = false;
                onClick();
            }
        };
    ...
    this._sprite.setCollider("rectangle", Screens.left(), Screens.top(), this._sprite.width, this._sprite.height);
